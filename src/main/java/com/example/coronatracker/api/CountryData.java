...
public class CountryData {
    ...
    @SerializedName("updated")  ///we can use it to take different name but we have to pass same name which is write in API and pass the value in @SerializedName();
    private String updated;

    private String country;     // we can also directly declare the variable;
